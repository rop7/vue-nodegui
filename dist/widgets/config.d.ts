...
export declare abstract class VNNode<WidgetProps extends {}> extends NodeWidget<any> {
    abstract insertChild(child: Component): void;
    abstract patchProp(key: keyof WidgetProps, prevValue: Prop<WidgetProps, keyof WidgetProps>, nextValue: Prop<WidgetProps, keyof WidgetProps>): void;
...
export declare abstract class VNWidget<WidgetProps> extends NodeWidget<any> implements VNNode<WidgetProps> {
...
export declare abstract class WidgetConfig<WidgetProps> {
