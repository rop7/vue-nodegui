...
export declare const RadioButtonPropsSetters: PropSetters<VNRadioButton, RadioButtonProps>;
/** @internal */
export declare class VNRadioButton extends QRadioButton implements VNWidget<RadioButtonProps> {
    insertChild(): void;
    patchProp(key: keyof RadioButtonProps, prevValue: Prop<RadioButtonProps, typeof key>, nextValue: Prop<RadioButtonProps, typeof key>): void;
    removeChild(): void;
    insertBefore(): void;
